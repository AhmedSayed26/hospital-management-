...
public class PatientService implements IPatientService {
    ...
    private PatientDto convertToPatientDto(Patient patient) {
        return PatientDto.builder()
                ...
                .roomEndDate(patient.getRoomEndDate())
    ...
    private List<AppointmentDto> convertAppointmentToDtoList(List<Appointment> appointments) {
        ...
        return appointments.stream()
                .map(appointment -> {
                    ...
                    var mappedPatient = appointment.getPatient();
                    return AppointmentDto.builder()
                            ...
                            .specialty(doctor != null && doctor.getSpecialty() != null
                                    ...
                                    : null)
                            .patientId(mappedPatient != null ? mappedPatient.getId() : null)
                            .patientName(mappedPatient != null ? mappedPatient.getName() : null)
                            .disease(mappedPatient != null && mappedPatient.getDisease() != null
                                    ? String.valueOf(mappedPatient.getDisease())
                                    : null)
                            .build();
                })
                .toList();
