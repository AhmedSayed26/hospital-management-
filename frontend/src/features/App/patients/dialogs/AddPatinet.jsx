...
export default function AddPatient({ onCreated }) {
  ...
  const formik = useFormik({
    ...
    initialValues: emptyPatientValues,
    validationSchema: getPatientValidationSchema({ passwordRequired: true }),
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        await PatientServices.CreatePatient(toPatientPayload(values));
        ...
        <form onSubmit={formik.handleSubmit} className="grid gap-4">
          ...
          <div className="grid max-h-[60vh] gap-3 overflow-y-auto px-1 py-1">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                <label htmlFor="add-patient-age" className="text-sm font-medium">
                  Age
                </label>
                <Input
                  id="add-patient-age"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <label htmlFor="add-patient-email" className="text-sm font-medium">
                  Email
                </label>
                <Input
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                <label htmlFor="add-patient-date" className="text-sm font-medium">
                  Registration date
                </label>
                <DataPicker
                  id="add-patient-date"
            ...
            <div className="space-y-1.5">
              <label htmlFor="add-patient-password" className="text-sm font-medium">
                Password
              </label>
          ...
          <DialogFooter>
            <Button type="submit" disabled={formik.isSubmitting}>
              {formik.isSubmitting ? "Saving..." : "Add Patient"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
